...
TRACKS = {
    "character_story": {
        ...
        "title_style": "命运反差 / 悬念缺口——用身份落差、不为人知的秘密、结局悬念抓人。"
                       "如「从乞丐到帝王，他只用了15年」「她死后300年，秘密才被揭开」",
    ...
    "health_book": {
        ...
        "title_style": "反常识 + 痛点 + 利益点——打破养生误区、戳中关切、给出确定性好处，"
                       "但口吻克制不恐吓、不做疗效承诺。如「你以为在养生，其实可能在伤身」"
                       "「过了60岁，做对这一件事就够了」",
    ...
    "culture_science": {
        ...
        "title_style": "好奇缺口 / 颠覆认知——用你不知道的真相、原来如此、纠正常识抓人。"
                       "如「古人原来这样过冬，比空调还讲究」「这个字，99%的人都写错了」",
    ...
    "folk_tale": {
        ...
        "title_style": "悬念 + 因果 / 善恶报应——用诡异开场、因果反转、警示抓人。"
                       "如「他半夜捡了个铜钱，第二天就后悔了」「行善三年，老天还他一个奇迹」",
