...
def _ensure_columns():
    ...
    pending = [
        ...
        ("tasks", "hashtags", "JSON"),
        ("tasks", "comment_cta", "JSON"),
        ("tasks", "image_gen_mode", "VARCHAR(12) DEFAULT 'per_image'"),
        ("tasks", "image_count_mode", "VARCHAR(12) DEFAULT 'auto'"),
        ...
        ("configs", "image_base_url", "VARCHAR(300) DEFAULT 'https://api.apib.ai/v1/images/generations'"),
        ("configs", "image_model", "VARCHAR(80) DEFAULT 'gpt-image-2'"),
